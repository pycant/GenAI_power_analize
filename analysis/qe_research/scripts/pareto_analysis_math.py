...
QUALITY_FILE = PROJECT_ROOT / 'data' / 'analize' / 'results' / 'math_quality' / 'math_quality_processed.csv'
...
def load_and_prepare_data():
    ...
    energy_dict, speed_dict = load_energy_speed_data('math', DATA_PATHS['energy'], DATA_PATHS['speed'])
...
def main():
    ...
    task_config = {
        'task_name': 'math',
        'task_name_cn': '数学推理',
        'quality_metric': '数值匹配准确率',
        'report_filename': 'MATH_PARETO_ANALYSIS_REPORT.md'
    }
    ...
    # 打印分析摘要
    print_analysis_summary(df, results, "数学推理任务")
