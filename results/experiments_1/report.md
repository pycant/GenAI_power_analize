...
## 多元统计分析摘要
- 主成分分析: PC1解释 67.08%, PC2解释 27.33%
- 对应分析: 维度1惯量占比 0.00%, 维度2占比 0.00%
- 典型相关: 质量与效率集合相关系数 1.000
- 聚类: 分为 3 类 -> {'deepseek-r1:8b': 1, 'gemma3:4b': 2, 'qwen3:4b': 2, 'qwen3:8b': 0}
